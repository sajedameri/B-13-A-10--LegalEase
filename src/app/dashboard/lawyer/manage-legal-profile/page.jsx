...
export default function ManageLegalServices() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6 space-y-6 bg-background">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-divider">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Configure the direct legal offerings, hourly billing scales, and photos visible on your
            public details profile page.
          </p>
        </div>
        <Button
          variant="primary"
      ...
      <Table
        variant="primary"
        className="w-full border border-divider rounded-xl overflow-hidden shadow-2xs"
      >
            ...
            <Table.Body
              ...
              renderEmptyState={() => (
                <div className="text-center py-14 text-muted-foreground text-xs font-medium">
                  You have not published any active legal service packages yet. Click Create Service
                  to start.
                </div>
              )}
            >
                  ...
                  <Table.Cell>
                    <div className="flex items-center gap-3">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src =
                            'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=150';
                        }}
                      />
